# 0 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.cpp"
# 1 "/home/piotr/Projects/dotman/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.cpp"
# 1 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.hpp" 1
...
# 1219 "/usr/include/c++/15.2.1/type_traits" 3
 ...
 "template argument must be a complete class or an unbounded array");
  ...
  template<typename _Tp>
    ...
    { };
# 1403 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
...
# 2869 "/usr/include/c++/15.2.1/type_traits" 3
...
# 2909 "/usr/include/c++/15.2.1/type_traits" 3
...
# 3766 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
    struct remove_cvref
    { using type = __remove_cvref(_Tp); };
# 3783 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
    using remove_cvref_t = typename remove_cvref<_Tp>::type;
# 3793 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
    struct type_identity { using type = _Tp; };

  template<typename _Tp>
    using type_identity_t = typename type_identity<_Tp>::type;
# 3806 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
...
# 3833 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
    inline constexpr bool is_bounded_array_v = __is_bounded_array(_Tp);
# 3847 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
    inline constexpr bool is_unbounded_array_v = __is_unbounded_array(_Tp);
# 3859 "/usr/include/c++/15.2.1/type_traits" 3
  template<typename _Tp>
...
# 538 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
  template<range _Range>
 ...
 { ranges::data(__t) } -> same_as<add_pointer_t<range_reference_t<_Tp>>>;
  ...
  namespace __access
  {
# 658 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
 ...
 if constexpr (is_lvalue_reference_v<_To>)
   ...
   return static_cast<const _Tp&&>(__t);
    ...
    struct _CBegin
    {
# 687 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
      template<typename _Tp>
 [[nodiscard]]
 constexpr auto
 operator()(_Tp&& __e) const
 ...
 requires requires { _Begin{}(__access::__as_const<_Tp>(__e)); }
 {
   return _Begin{}(__access::__as_const<_Tp>(__e));
    ...
    struct _CEnd final
    {
# 715 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
      template<typename _Tp>
 [[nodiscard]]
 constexpr auto
 operator()(_Tp&& __e) const
 ...
 requires requires { _End{}(__access::__as_const<_Tp>(__e)); }
 {
   return _End{}(__access::__as_const<_Tp>(__e));
    ...
    struct _CRBegin
    {
# 743 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
      template<typename _Tp>
 [[nodiscard]]
 constexpr auto
 operator()(_Tp&& __e) const
 ...
 requires requires { _RBegin{}(__access::__as_const<_Tp>(__e)); }
 {
   return _RBegin{}(__access::__as_const<_Tp>(__e));
    ...
    struct _CREnd
    {
# 771 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
      template<typename _Tp>
 [[nodiscard]]
 constexpr auto
 operator()(_Tp&& __e) const
 ...
 requires requires { _REnd{}(__access::__as_const<_Tp>(__e)); }
 {
   return _REnd{}(__access::__as_const<_Tp>(__e));
    ...
    struct _CData
    {
# 794 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
      template<typename _Tp>
 [[nodiscard]]
 constexpr auto
 operator()(_Tp&& __e) const
...
# 826 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
  namespace __detail
  {
    template<typename _Tp>
 ...
 if constexpr (random_access_iterator<_It>)
  ...
  while (++__n);
 ...
 else
   {
     ...
     do { if (__builtin_expect(!bool(__n >= 0), false)) std::__glibcxx_assert_fail("/usr/include/c++/15.2.1/bits/ranges_base.h", 876, __PRETTY_FUNCTION__, "__n >= 0"); } while (false);
     while (__n-- > 0)
       ++__it;
   }
      }
 ...
 if constexpr (sized_sentinel_for<_Sent, _It>)
  ...
  do { if (__builtin_expect(!bool((__n < 0) == (__diff < 0)), false)) std::__glibcxx_assert_fail("/usr/include/c++/15.2.1/bits/ranges_base.h", 915, __PRETTY_FUNCTION__, "(__n < 0) == (__diff < 0)"); } while (false);
  ...
  --__m;
 ...
 else
   {
     ...
     do { if (__builtin_expect(!bool(__n >= 0), false)) std::__glibcxx_assert_fail("/usr/include/c++/15.2.1/bits/ranges_base.h", 950, __PRETTY_FUNCTION__, "__n >= 0"); } while (false);
     return __n;
   }
      }
...
# 1126 "/usr/include/c++/15.2.1/bits/ranges_base.h" 3
...
# 3 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.hpp" 2


# 4 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.hpp"
...
# 2 "/home/piotr/Projects/dotman/src/cli/ArgumentParser.cpp" 2
